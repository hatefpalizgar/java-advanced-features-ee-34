package com.sda.p24_concurrency.threadpool;
...
public class Main {
    public static void main(String[] args) {
        // Java provides the ExecutorService interface,
        // which defines a thread pool and provides methods for managing and executing tasks
        // here, we create a fixed-size thread pool with 5 threads
        ...
        // The thread pool has unbounded number of threads
        // + better performance for short-lived tasks
        // + thread reuse
        ExecutorService executorCached = Executors.newCachedThreadPool();

        // once we have a thread pool, we should submit tasks to them
        ...
        executorFixed.submit(runnable);


        // shut down the executor service to prevent any new tasks from being submitted
